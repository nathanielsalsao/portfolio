...
// Importing from your existing UI folder structure
...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const createScrollAnimations = () => {
        ...
        // These animate the SideCards you already have
        gsap.to(leftTextRef.current, { yPercent: -120, scrollTrigger: scrollConfig });
        gsap.to(rightTextRef.current, { yPercent: 20, scrollTrigger: scrollConfig });
        
        // Main card shrink/shift
  ...
  return (
    <section id="home"
      ...
      className="relative w-full min-h-screen flex items-start justify-center pt-7 px-6 text-white overflow-hidden font-['Plus_Jakarta_Sans'] [perspective:1500px]"
    >
      ...
      <HeroCard ref={cardRef}>
        <HeroContent contentRef={contentRef as React.RefObject<HTMLDivElement>} />
      </HeroCard>
